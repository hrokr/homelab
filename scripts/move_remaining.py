...
# Getting more data in: Environment-aware paths for portability
...
def run_sync():
    # Getting more data in: Pre-check for source directory existence
    ...
    for root, _, files in os.walk(source_dir):
        for name in files:
            ...
            # Compare quality: Upgrade if source is higher than target
